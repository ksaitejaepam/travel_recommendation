...
--SELECT  'John', 'Doe', 'user@epam.com', '$2a$12$0dUqsdZ6XcOJQqTduGo7QuSiE.8dgUsjqs71fCJMzeIbXU5HXw63q', 'Male', 'USA', 'New York', 'User'
--WHERE NOT EXISTS (
...
--INSERT INTO users (id, first_name, last_name, email, password, gender, country, city, role)
--SELECT  'Jane', 'Smith', 'admin@epam.com', '$2a$12$hIArTwcUrcLf5LcdMO1buuydrd1lslCk1U6A.gIOc7zjhmrKvmedy', 'Female', 'USA', 'Los Angeles', 'Admin'
--WHERE NOT EXISTS (
